...
\section*{四、核心代码}
下面给出核心实现片段。完整代码包含数据生成、评估和可视化。The code of this part is available at \footnote{https://github.com/HaoranYuandomestic/ex4\_PCA.git}
...
\section*{五、实验结果与分析}
实验运行后，含噪数据经过 PCA 降维重建得到去噪结果。对比可以看到，去噪后样本分布整体更接近干净数据的主结构，离散噪声点明显减少。从指标上看：
\begin{enumerate}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{data_compare.png}
